...
public class RequestHandlerConnection extends AbstractStatisticConnection {
	...
	private CacheData getCacheData(NamedList<Object> namedList, String cacheName) {
	  NamedList<Object> cache = getCacheNamedList(namedList, cacheName);
	   if(cache == null) {
		...
		return new CacheData((Long)stats.get("lookups"), (Long)stats.get("hits"), Float.valueOf(stats.get("hitratio").toString()), (Long)stats.get("inserts"), (Long)stats.get("evictions"), Long.valueOf(stats.get("size").toString()), (Long)stats.get("warmupTime"));
	}
  ...
  private NamedList<Object> getCacheNamedList(NamedList<Object> namedList,
   ...
   NamedList<Object> stats = (NamedList<Object>)cache.get("stats");
		return new CacheData((Long)stats.get("cumulative_lookups"), (Long)stats.get("cumulative_hits"), Float.valueOf(stats.get("cumulative_hitratio").toString()), (Long)stats.get("cumulative_inserts"), (Long)stats.get("cumulative_evictions"));
	}
